...
import CalendarDayEvent from '@/components/user/CalendarDayEvent';
    ...
    <div className="bg-card rounded-xl shadow-lg flex flex-col h-full">
      ...
      <div className="flex justify-between items-center px-8 py-3 md:px-8 md:py-3 border-b border-border flex-shrink-0">
        ...
        <div className="flex gap-2">
          <button onClick={() => changeMonth(-1)} title="Mese precedente" className="p-2 rounded-full hover:bg-muted text-muted-foreground">
            <ChevronLeft size={20} />
          </button>
          <button onClick={() => changeMonth(1)} title="Mese successivo" className="p-2 rounded-full hover:bg-muted text-muted-foreground">
