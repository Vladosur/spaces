...
import UserBookingsPage from '@/components/user/UserBookingsPage';
import AdminDashboard from '@/components/admin/AdminDashboard';
import AdminGeneralCalendar from '@/components/admin/AdminGeneralCalendar';
...
import ValidationSettingsPage from '@/components/admin/ValidationSettingsPage';
import UserManagement from '@/components/admin/UserManagement';
import EmailSettingsPage from '@/components/admin/EmailSettingsPage';
import ProfilePage from '@/components/profile/ProfilePage';
import DayTimelinePage from '@/components/user/DayTimelinePage';
