        ...
        <div className="w-full mx-auto p-4">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-4">
                <div className="flex items-center gap-2 md:gap-4 bg-muted/30 p-1 rounded-lg border border-border/50">
                    <button title="Periodo precedente" onClick={() => viewMode === 'week' ? onChangeMonth(-1) : onChangeDay(-1)} className="p-1.5 rounded-md hover:bg-card hover:text-primary shadow-sm transition-all"><ChevronLeft size={18} /></button>
                    ...
                    <button title="Periodo successivo" onClick={() => viewMode === 'week' ? onChangeMonth(1) : onChangeDay(1)} className="p-1.5 rounded-md hover:bg-card hover:text-primary shadow-sm transition-all"><ChevronRight size={18} /></button>
                </div>
            ...
            {viewMode === 'week' && (
                <div className="flex items-center">
                    <button title="Settimana precedente" onClick={() => onChangeWeek(-1)} className="p-1 rounded-full hover:bg-muted text-muted-foreground hover:text-foreground transition-colors"><ChevronLeft size={20} /></button>
                    ...
                    <button title="Settimana successiva" onClick={() => onChangeWeek(1)} className="p-1 rounded-full hover:bg-muted text-muted-foreground hover:text-foreground transition-colors"><ChevronRight size={20} /></button>
                </div>
            )}
        </div>
    </div>
